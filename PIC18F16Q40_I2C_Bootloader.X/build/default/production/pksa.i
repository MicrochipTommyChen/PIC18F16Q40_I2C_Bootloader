...
void I2C_Slave_Init()
{
    ...
    I2C1ADR0 = (uint8_t) (0x18 << 1);
    I2C1ADR2 = (uint8_t) (0x18 << 1);

    I2C1ADR1 = (uint8_t) (127 << 1);
    I2C1ADR3 = (uint8_t) (127 << 1);
            ...
            else
            {
                ...
                switch (i2cSlaveState)
                {
                    ...
                    case I2C_DATA_RX:
                        ...
                        else if ( pksa_status == 2 )
                        {
                            if ( pksa_wd_address == 0x01)
                            {
                                if (pksa_index == 0)
                                {
